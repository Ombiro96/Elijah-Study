...
export const metadata: Metadata = {
  title: "Week 2 & 3: Who is God? & When God's Servants Break — The Prophet Elijah",
};
...
export default function Week2And3Page() {
  return (
    <WeekLayout
      week="2 & 3"
      title="Who is God? / When God's Servants Break"
      subtitle="The God who turns hearts back to Himself — and the same God who, one chapter later, gently restores the faithful servant who asks to die. 1 Kings 18 is usually taught as Elijah's finest hour, but Elijah's own prayer refuses the credit; 1 Kings 19 is one of Scripture's most honest portraits of a servant who has reached the end of himself."
      toc={toc}
      prevHref="/week/1"
      nextHref="/week/4"
    >
      ...
      <WeekSection id="verdict" kicker="The Ending" title="God Was Victorious">
        ...
        <p>
          And that makes what happens next stronger, not weaker. If God has just turned a
          nation&rsquo;s heart back to Himself &mdash; and just carried His prophet seventeen miles by
          His own hand &mdash; why is Elijah running?
        </p>
        <p>
